...
(function() {
  ...
  Preloader.prototype = {
    ...
    preload: function () {
        ...
        this.asset = this.add.sprite(
          ...
          this.game.world.bounds.height / 2, 'preloader');
        ...
        this.load.spritesheet(
          'headHero',
          'assets/sprites/head-sprite.png', 80, 80);
        this.load.spritesheet(
          'bodyHero',
          'assets/sprites/body-sprite.png', 80, 80);
        this.load.spritesheet('items', 'assets/sprites/items.png', 50, 50);
        this.load.spritesheet('buttons', 'assets/sprites/buttons.png', 70, 70);
        this.load.spritesheet(
          'button-retry',
          'assets/sprites/button-retry.png', 225, 112);
        this.load.spritesheet(
          'button-fb',
          'assets/images/facebook_button.png', 64, 64);
        this.load.spritesheet(
          'button-twitter',
          'assets/images/twitter_button.png', 64, 64);
        ...
        ['assets/sounds/kidLevel.ogg', 'assets/sounds/kidLevel.mp3']);
        this.game.load.audio('mainMenuMusic',
        ['assets/sounds/mainMenu.ogg', 'assets/sounds/mainMenu.mp3']);
  ...
  window['virtualJCare'].Preloader = Preloader;
}());
